...
public class BunnyLog {
    ...
    // Crucial for production debugging: print the message too, not only the
    // stack trace. Without it every contextual detail the caller took the
    // trouble to build (guild id, user id, action) was silently discarded.
