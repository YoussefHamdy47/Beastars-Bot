...
public class CommandLoader {
    ...
    public static void loadCommands(BunnyHub client, CommandRegistry registry, String packageName) {
        ...
        for (Class<? extends BunnyCommand> clazz : classes) {
            ...
            try {
                ...
                BunnyLog.warning("[CommandLoader] " + clazz.getSimpleName()
                        + " has no BunnyHub constructor; ignored.");
            } catch (InstantiationException | IllegalAccessException | InvocationTargetException e) {
                BunnyLog.error("[CommandLoader] Could not initialise " + clazz.getSimpleName(), e);
            }
        }
